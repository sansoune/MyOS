...
build: clean
	...
	i386-elf-ld -o ./build/kernel.bin -T ./src/kernel/linker.ld -nostdlib ./build/kernel.o ./build/main.o ./build/stdio.o ./build/io.o ./build/pic.o ./build/conversion.o ./build/string.o ./build/kb.o ./build/idt.o ./build/isr.o ./build/irq.o ./build/interrupts.o ./build/gdt_asm.o ./build/gdt.o
